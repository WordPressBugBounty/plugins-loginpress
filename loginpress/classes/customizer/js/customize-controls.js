(function ($) {
	...
	wp.customize.bind(
		...
		function () {
			...
			function updateValues($controlWrapper, settingName, type, inputvalue=false) {
				...
				if (type) {
					...
					if (highestValue) {
						...
						$controlWrapper.find( 'input[type="number"]' ).each(
							function () {
			...
			function bindControlEvents($controlWrapper, settingName) {
				...
				$controlWrapper.find( 'input[type="number"]' ).on(
					'input change keyup',
					function () {
				...
				$controlWrapper.find( 'select[id*="_unit"]' ).on(
					'change',
					function () {
				...
				$controlWrapper.find( 'input[type="checkbox"][id*="_lock"]' ).on(
					'change',
					function () {
						updateValues( $controlWrapper, settingName, true );
					}
	...
	wp.customize(
		'loginpress_customization[textfield_inset_shadow]',
		function ( value ) {
			value.bind(
				function ( loginPressVal ) {
			...
			function (value) {
				value.bind(
					function ( loginPressVal ) {
						...
						if ('loginpress_customization[lp_random_bg_img_check]' == setting && false == loginPressVal) {
							$( '#customize-control-loginpress_customization-lp_random_bg_img_upload' ).fadeOut().css( 'display', 'none' );
						} else if ('loginpress_customization[lp_random_bg_img_check]' == setting && true == loginPressVal) {
							$( '#customize-control-loginpress_customization-lp_random_bg_img_upload' ).fadeIn().css( 'display', 'list-item' );
						}
	...
	function loginpress_customizer_bg(customizer_bg) {
		...
		if ( 'default1' == customizer_bg && loginpress_script.filter_bg.length > 0 ) {
			...
			loginpress_bg = 'url(' + loginpress_script.plugin_url + '/loginpress-pro/assets/img/bg11.jpg)';
	...
	loginpress_display_control( 'loginpress_customization[lp_random_bg_img_check]' );
	...
	wp.customize(
		'loginpress_customization[custom_button_color]',
		function (value) {
			value.bind(
				function (loginPressVal) {
					if ( loginPressVal == '' ) {
							...
							loginpress_find( '.wp-core-ui #login  .button-primary' ).on(
								'mouseover',
								function () {
	...
	wp.customize(
		'loginpress_customization[button_border_color]',
		function (value) {
			value.bind(
				function (loginPressVal) {
					if ( loginPressVal == '' ) {
	...
	// Update the login form button border-color in real time...
	wp.customize(
		'loginpress_customization[button_hover_color]',
		function (value) {
			value.bind(
				function (loginPressVal) {
					if ( loginPressVal == '' ) {
	...
	// Update the login form button border-color in real time...
	wp.customize(
		'loginpress_customization[button_hover_border]',
		function (value) {
			value.bind(
				function (loginPressVal) {
					if ( loginPressVal == '' ) {
	...
	wp.customize(
		'loginpress_customization[button_hover_text_color]',
		function (value) {
			value.bind(
				function (loginPressVal) {
					if ( loginPressVal == '' ) {
	...
	// Update the login form button border-color in real time...
	wp.customize(
		'loginpress_customization[custom_button_shadow]',
		function (value) {
			value.bind(
				function (loginPressVal) {
					if ( loginPressVal == '' ) {
	...
	wp.customize(
		'loginpress_customization[button_text_color]',
		function (value) {
			value.bind(
				function (loginPressVal) {
					if ( loginPressVal == '' ) {
			...
			value.bind(
				function (loginPressVal) {
					...
					if ( loginPressVal == '' ) {
							...
							loginpress_find( '.login #nav a, .login #nav' ).on(
								'mouseover',
								function () {
				...
				function (loginPressVal) {
					...
					if ( loginPressVal == '' ) {
						loginPressFtrClr = '';
							...
							loginpress_find( '.login #nav a' ).on(
								'mouseover',
								function () {
									$( this ).css( 'color', '' );
								}
			...
			value.bind(
				function ( loginPressVal ) {
					...
					if ( loginPressVal == '' ) {
						...
						loginpress_find( '.login #backtoblog a' ).on(
							'mouseover',
							function () {
	...
	$( window ).on(
		...
		function () {
			...
			if ( $( '#customize-control-loginpress_customization-loginpress_display_bg input[type="checkbox"]' ).is( ":checked" ) ) {
				...
				$( '#customize-control-loginpress_customization-loginpress_display_bg' ).nextUntil( '#customize-control-loginpress_customization-random_bg_group' ).hide();
			...
			if ( $( '#customize-control-loginpress_customization-lp_random_bg_img_check input[type="checkbox"]' ).is( ":checked" ) ) {

				$( '#customize-control-loginpress_customization-lp_random_bg_img_upload' ).css( 'display', 'list-item' );
			} else {

				$( '#customize-control-loginpress_customization-lp_random_bg_img_upload' ).css( 'display', 'none' );
			}
			...
			if ( $( '#customize_presets_settingsdefault18' ).is( ':checked' ) == true ) {
				...
				loginpress_find( '#loginform #user_pass' ).on(
					'focus',
					function () {
